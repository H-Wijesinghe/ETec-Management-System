...
public class InventoryService {
    ...
    private void loadDummyData() {
        ...
        for (int i = 1; i <= 500; i++) {
            ...
            masterList.add(new ProductDTO("p"+i,"Item 2222222222222222222222222" + i,"description about the product, must be under the three line", 1000 + (i * 50), cat, "placeholder.png", 800 + (i * 40), 12 + (i % 24),USED, (i % 50)));
        }
