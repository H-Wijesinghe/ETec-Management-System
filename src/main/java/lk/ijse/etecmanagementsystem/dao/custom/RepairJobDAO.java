...
public interface RepairJobDAO {
    ...
    RepairJobDTO getRepairJobById(int repair_id) throws SQLException;

    boolean saveRepairJob(RepairJobDTO dto) throws SQLException;

    int getLastInsertedRepairId() throws SQLException;

    boolean updateRepairJob(RepairJobDTO dto) throws SQLException;
